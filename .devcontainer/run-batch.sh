...
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/repast.simphony.runtime_2.11.0.jar"
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/repast.simphony.core_2.11.0.jar"
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/repast.simphony.batch_2.11.0.jar"
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/repast.simphony.data_2.11.0.jar"
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/repast.simphony.essentials_2.11.0.jar"
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/repast.simphony.dataLoader_2.11.0.jar"
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/repast.simphony.distributed.batch.ui_2.11.0.jar"
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/groovy-all_2.11.0.jar"
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/libs.ext_2.11.0.jar"
# Extracted classes and libraries from OSGI bundles
...
CLASSPATH="$CLASSPATH:$REPAST_PLUGINS/repast.simphony.distributed.batch.ui_2.11.0_extracted/bin-standalone"
