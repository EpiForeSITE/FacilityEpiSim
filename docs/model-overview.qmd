...
Each patient has an associated `PersonDisease` object that represents 3 states:
...
3. They become transmissible and can transmit to other patients
...
- **Outcome**: If detected by surveillance, patient is isolated
...
2. **Perfect detection**: Detected patients are immediately and perfectly isolated
3. **No treatment**: Decolonization only through natural clearance
4. **No reinfection**: Once decolonized, patients are not immediately re-infected
