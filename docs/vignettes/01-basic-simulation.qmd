...
#### `transmissions.demo.txt` (if enabled)
```
...
daily_stats <- read_csv("../data/daily_population_stats.demo.txt")
...
```r
# Load admissions
admissions <- read.csv("../data/admissions.demo.txt", sep = ",")

# Count imported vs. acquired cases
admitted <- read.table("../data/admissions.demo.txt", sep = ",", header = FALSE)
