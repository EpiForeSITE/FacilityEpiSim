...
```bash
cp ../data/simulation_results.demo.txt baseline_results.txt
cp ../data/daily_population_stats.demo.txt baseline_daily.txt
...
# Load all scenarios
results <- bind_rows(
  load_scenario("../data/daily_population_stats.demo.txt", "Baseline"),
  load_scenario("../data/daily_population_stats.demo.txt", "No Surveillance"),
  load_scenario("../data/daily_population_stats.demo.txt", "Intensive"),
  load_scenario("../data/daily_population_stats.demo.txt", "Perfect Isolation")
)
```
