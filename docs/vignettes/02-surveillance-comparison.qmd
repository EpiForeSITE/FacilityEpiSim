...
```bash
cp simulation_results.txt baseline_results.txt
cp daily_population_stats.txt baseline_daily.txt
...
# Load all scenarios
results <- bind_rows(
  load_scenario("baseline_daily.txt", "Baseline"),
  load_scenario("no_surveillance_daily.txt", "No Surveillance"),
  load_scenario("intensive_daily.txt", "Intensive"),
  load_scenario("perfect_isolation_daily.txt", "Perfect Isolation")
)
```
