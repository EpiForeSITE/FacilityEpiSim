...
This page documents the public API of the Single-Facility Disease Transmission Model. For detailed source code documentation, see the [Javadoc](../docs/index.html).
