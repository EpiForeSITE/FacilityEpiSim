...
format:
  html:
    include-in-header:
      text: |
        <meta http-equiv="refresh" content="3; url=javadoc/index.html">
---

## API Documentation

The complete API documentation is available in Javadoc format.

**[View Full API Documentation (Javadoc)](javadoc/index.html){.btn .btn-primary}**
...
- **Source Code**: See [Javadoc](../docs/index.html)
- **Architecture**: See [Architecture & Design](architecture.qmd)
- **Example Usage**: See [Basic Simulation Vignette](../vignettes/01-basic-simulation.qmd)
- **Model Details**: See [Model Overview](model-overview.qmd)
