...
**Quick Patient Selection Guide:** - **High Activity Patients**: See the top 20 table below - **Random Selection**: Any ID from the discharged patients list - **Current Patient**: `r params$patient_id`
:::
