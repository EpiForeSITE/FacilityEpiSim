---
title: 'facilitysim: an agent-based simulation package for infectious disease transmission in healthcare facilities'
tags:
  - Java
  - Repast
  - agent-based model
...
reduce transmission. We developed facilitysim, a continuous-time, agent-based simulation model of
