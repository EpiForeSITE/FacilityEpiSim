...
![Parameters panel available when running the non-batch version of the simulation in Repast Simphony.\label{fig:parampanel}](./docs/vignettes/images/parameters-panel.JPG){ width=30% }
